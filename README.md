...
----------
* Transpiling * is the process of compiling one language to another. In angular, Traceur compiler converts Typescript into java script code for the browsers.
...
1. Interpolation is a one way binding, value going from component to template for string values only.
<input type="submit" class="btn" value="{{ btnText }}">

2. Property binding: Angular evaluates an expression and assigns it some property of underlyin HTML DOM element, component, service etc.
<input type="submit" class="btn" [value]="btnText">
...
——————————
Adding and using 3rd party libraries: eg. moment.js (https://www.npmjs.com/package/angular-moment)
